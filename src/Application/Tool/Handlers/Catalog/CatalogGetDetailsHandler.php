...
final class CatalogGetDetailsHandler implements ToolHandlerInterface
{
    ...
    public function __construct(CatalogToolService $tools)
    {
        ...
        $this->contract = new ToolContract(
            'catalog_get_details',
            ToolPromptDescriptions::for('catalog_get_details'),
    ...
    {
        return $this->tools->details($arguments, $context);
    }
}
